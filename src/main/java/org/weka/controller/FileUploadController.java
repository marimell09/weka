...
public class FileUploadController {
	...
	String uploadMultipleFileHandler(@RequestParam("name") String[] names,
	 ...
	 private void treinando(String caminho){
		 Arquivo arq = new Arquivo();
		 ArvoreDecisao arvore = new ArvoreDecisao();
		 
		 Instances instanciaDados = arq.lerArquivoTransformarEmInstancias(caminho);
		 Classifier cls = arvore.construirModelo(instanciaDados);
